...
Formalize the local deduction in `proof/attempts/ATT-0136.json` under the exact contract
...
Black-box mathematical inputs are allowed only when mapped faithfully to one of the nine
