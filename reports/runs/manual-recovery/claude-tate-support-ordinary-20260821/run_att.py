#!/usr/bin/env python3
"""One ordinary Claude C66-TATE-SUPPORT mathematics turn with current packet/WC.

Official retry after ATT-0113 would be Qwen; PI selects Claude. Qwen weekly
quota is exhausted until 12:50 UTC. Packet includes corroborated FND-0164.
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "ordinary Claude TATE-SUPPORT; PI override of Qwen retry; packet includes FND-0164; ATT-0113 incomplete; no forced-proof; no model fallback",
            ...
            notify(
                "Pure Tate • Claude TATE-SUPPORT starting",
        ...
        notify("Pure Tate • Claude TATE-SUPPORT blocked", str(exc))
