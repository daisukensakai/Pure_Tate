#!/usr/bin/env python3
"""Parallel: Codex P2 of ATT-0119 plus xAI Grok FAUD of FND-0176..0178.

One campaign lock; four concurrent run_task calls. Not C66-FULL. No model fallback.
"""
...
P2_TASK_ID = "TASK-V-ATT-0119-P2"
TARGET_ATTEMPT = "ATT-0119"
AUDIT_FINDING_IDS = ("FND-0176", "FND-0177", "FND-0178")
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "parallel Codex P2 of ATT-0119 plus xAI Grok FAUD of "
                    "FND-0176..0178; no model fallback"
                ),
                "jobs": jobs,
            ...
            notify(
                "Pure Tate • Codex P2 + Grok audits starting",
                "%s • %s plus %s"
                % (
                    CAMPAIGN_ID,
                    p2_job["artifact_id"],
        ...
        notify("Pure Tate • Codex P2 + Grok audits blocked", str(exc))
