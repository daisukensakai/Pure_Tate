#!/usr/bin/env python3
"""Run xAI Grok's independent P2 review of forced proof ATT-0135."""
...
CAMPAIGN_ID, ATTEMPT_ID, TASK_ID, ENGINE = "C66-001", "ATT-0135", "TASK-V-ATT-0135-P2", "grok"
...
def main() -> int:
    with CampaignRunLock(CAMPAIGN_ID):
        ...
        if len(matches) != 1 or matches[0].get("status") != "ready":
            raise RuntimeError("ATT-0135 has no ready P2 review")
        task = dict(matches[0])
