#!/usr/bin/env python3
"""One Claude P1 review of ATT-0120.
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "Claude P1 of ATT-0120 grok SUPPORT-INTERFACE lemma; "
            ...
            notify(
                "Pure Tate • Claude ATT-0120 P1 starting",
        ...
        notify("Pure Tate • Claude ATT-0120 P1 blocked", str(exc))
