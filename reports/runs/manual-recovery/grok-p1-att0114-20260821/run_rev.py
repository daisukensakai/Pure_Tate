#!/usr/bin/env python3
"""One Grok P1 review of ATT-0114. Official first reviewer is cursor-grok; PI selects grok CLI."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0114-P1"
TARGET_ATTEMPT = "ATT-0114"
ENGINE = "grok"
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["claude"], [ENGINE, "codex"]
            )
            ...
            launch = {
                "note": "Grok P1 of ATT-0114 Claude TATE-SUPPORT; then Codex finding-audits; no model fallback",
            ...
            notify(
                "Pure Tate • Grok ATT-0114 P1 starting",
        ...
        notify("Pure Tate • Grok ATT-0114 P1 blocked", str(exc))
