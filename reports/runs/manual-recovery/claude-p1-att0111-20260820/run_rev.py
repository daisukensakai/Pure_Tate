#!/usr/bin/env python3
"""One Claude P1 review of ATT-0111. Official drive would also pick Claude first."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0111-P1"
TARGET_ATTEMPT = "ATT-0111"
ENGINE = "claude"
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Claude P1 of ATT-0111 Codex GEO-COMP; official first reviewer; no model fallback",
            ...
            notify(
                "Pure Tate • Claude ATT-0111 P1 starting",
        ...
        notify("Pure Tate • Claude P1 blocked", str(exc))
