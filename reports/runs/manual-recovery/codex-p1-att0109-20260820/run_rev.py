#!/usr/bin/env python3
"""One Codex P1 review of ATT-0109. Official drive would select Grok first."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0109-P1"
TARGET_ATTEMPT = "ATT-0109"
ENGINE = "codex"
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Codex P1 of ATT-0109 wrap-up; official drive would pick Grok; no model fallback",
            ...
            notify(
                "Pure Tate • Codex ATT-0109 P1 starting",
        ...
        notify("Pure Tate • Codex P1 blocked", str(exc))
