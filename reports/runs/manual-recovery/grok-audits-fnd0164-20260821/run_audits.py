#!/usr/bin/env python3
"""One Grok finding-audit of REV-0160 candidate FND-0164."""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0164", "engine": "grok"},
)
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Grok audit of REV-0160 candidate FND-0164; Codex excluded; no model fallback",
                "jobs": [],
