#!/usr/bin/env python3
"""Parallel xAI Grok FAUD of FND-0183 and FND-0184.

Codex already promoted FND-0186. No start notification. No model fallback.
"""
...
AUDIT_FINDING_IDS = ("FND-0183", "FND-0184")
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "parallel xAI Grok FAUD of FND-0183 and FND-0184; "
                    "Codex did FND-0186 only; no start notify; no model fallback"
                ),
                "jobs": jobs,
