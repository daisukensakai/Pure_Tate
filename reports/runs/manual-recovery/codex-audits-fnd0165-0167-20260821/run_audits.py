#!/usr/bin/env python3
"""Serial Codex finding-audits of REV-0161 candidates FND-0165..0167."""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0165", "engine": "codex"},
    {"finding_id": "FND-0166", "engine": "codex"},
    {"finding_id": "FND-0167", "engine": "codex"},
)
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "serial Codex audits of REV-0161 candidates FND-0165..0167; Grok excluded; no model fallback",
                "jobs": [],
