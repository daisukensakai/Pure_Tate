#!/usr/bin/env python3
"""One Codex P1 review of ATT-0125.

Official first reviewer after excluding prover claude is cursor-grok; PI
override to codex. No model fallback.
"""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0125-P1"
TARGET_ATTEMPT = "ATT-0125"
ENGINE = "codex"
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["claude"], [ENGINE, "grok"]
            )
            ...
            launch = {
                "note": (
                    "Codex P1 of ATT-0125 Claude TATE-SUPPORT proposed lemma; "
            ...
            notify(
                "Pure Tate • Codex ATT-0125 P1 starting",
        ...
        notify("Pure Tate • Codex ATT-0125 P1 blocked", str(exc))
