#!/usr/bin/env python3
"""One ordinary Qwen C66-TATE-SUPPORT mathematics turn with current packet/WC.

Official next retry on this cell is Qwen. Packet includes FND-0164..0167.
Not C66-FULL, not forced. No model fallback on quota.
"""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "ordinary Qwen TATE-SUPPORT; official next retry; packet includes FND-0164..0167; no forced-proof; no model fallback",
            ...
            notify(
                "Pure Tate • Qwen TATE-SUPPORT starting",
        ...
        notify("Pure Tate • Qwen TATE-SUPPORT blocked", str(exc))
