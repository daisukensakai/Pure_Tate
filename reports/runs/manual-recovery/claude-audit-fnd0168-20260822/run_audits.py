#!/usr/bin/env python3
"""One Claude finding-audit of REV-0163 candidate FND-0168."""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0168", "engine": "claude"},
)
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, STEPS, ["claude"], ["qwen"], ["grok", "codex"]
            )
            launch = {
                "note": "Claude audit of REV-0163 candidate FND-0168; Grok excluded; no model fallback",
                "jobs": [],
        ...
        notify("Pure Tate • Claude audit blocked", str(exc))
