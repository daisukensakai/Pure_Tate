#!/usr/bin/env python3
"""One Qwen P1 review of ATT-0112. Official drive would pick Grok first."""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Qwen P1 of ATT-0112 Claude GEO-COMP lemma; official first reviewer is Grok; no model fallback",
            ...
            notify(
                "Pure Tate • Qwen ATT-0112 P1 starting",
        ...
        notify("Pure Tate • Qwen P1 blocked", str(exc))
