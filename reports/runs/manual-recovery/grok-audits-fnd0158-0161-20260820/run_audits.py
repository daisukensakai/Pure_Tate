#!/usr/bin/env python3
"""Serial Grok finding-audits of REV-0156 candidates FND-0158..0161."""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0158", "engine": "grok"},
    {"finding_id": "FND-0159", "engine": "grok"},
    {"finding_id": "FND-0160", "engine": "grok"},
    {"finding_id": "FND-0161", "engine": "grok"},
)
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, STEPS, ["grok"], ["codex"], ["claude", "grok"]
            )
            launch = {
                "note": "serial Grok audits of REV-0156 candidates FND-0158..0161; no model fallback",
                "jobs": [],
            ...
            for index, task in enumerate(planned, start=1):
                ...
                notify(
                    "Pure Tate • Grok finding-audit starting",
