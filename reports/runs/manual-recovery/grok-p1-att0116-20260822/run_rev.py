#!/usr/bin/env python3
"""One xAI Grok P1 review of ATT-0116. Official first is cursor-grok; PI selects grok CLI."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0116-P1"
TARGET_ATTEMPT = "ATT-0116"
ENGINE = "grok"
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["qwen"], [ENGINE, "claude"]
            )
            ...
            launch = {
                "note": "xAI Grok P1 of ATT-0116 Qwen TATE-SUPPORT; official first is cursor-grok; no model fallback",
            ...
            notify(
                "Pure Tate • Grok ATT-0116 P1 starting",
        ...
        notify("Pure Tate • Grok ATT-0116 P1 blocked", str(exc))
