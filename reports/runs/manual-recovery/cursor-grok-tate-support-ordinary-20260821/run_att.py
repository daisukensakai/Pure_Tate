#!/usr/bin/env python3
"""One ordinary cursor-grok C66-TATE-SUPPORT mathematics turn with current packet/WC.

Harness first-attempt rotation for this untried cell is cursor-grok
(ordinary proof count 46, prover_rotation slot 4). Not C66-FULL, not forced.
"""
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], [ENGINE], ["claude", "codex"]
            )
            ...
            launch = {
                "note": "ordinary cursor-grok TATE-SUPPORT; harness rotation first; current packet+WC including FND-0162/0163; GEO-COMP dep ATT-0112; no forced-proof; no model fallback",
