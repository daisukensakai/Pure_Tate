#!/usr/bin/env python3
"""One Claude P1 review of ATT-0121.

Official first reviewer after excluding prover grok is cursor-grok; PI
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0121-P1"
TARGET_ATTEMPT = "ATT-0121"
ENGINE = "claude"
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "Claude P1 of ATT-0121 grok TATE-SUPPORT proposed lemma; "
            ...
            notify(
                "Pure Tate • Claude ATT-0121 P1 starting",
        ...
        notify("Pure Tate • Claude ATT-0121 P1 blocked", str(exc))
