#!/usr/bin/env python3
"""Resume Claude forced GEO-COMP after ATT-0107 session-limit failure.

ATT-0106 and ATT-0107 are spent. Same Claude session, new append-only ATT slot.
...
ENGINE = "claude"
FAILED_SLOT = "ATT-0107"
FAILED_TRACE = "TRACE-0068"
PRIOR_SPENT = ("ATT-0106", "ATT-0107")
        ...
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            prompt = "\n".join(
                [
                    ...
                    "by a Claude session limit (TRACE-0067 / ATT-0106). A later --resume",
                    "into ATT-0107 immediately hit another session limit (TRACE-0068) and",
                    "did no new mathematics. Official last stream:",
                    ...
                    "count), and begun the mathematics. Those workers finished. You still",
                    "have not emitted the JSON artifact.",
                    "",
                    "Spent/failed slots ATT-0106 and ATT-0107 are closed. Do NOT reopen",
                    "or overwrite them.",
            ...
            launch = {
                "note": (
                    "Claude --resume after ATT-0107 session limit; same session; "
