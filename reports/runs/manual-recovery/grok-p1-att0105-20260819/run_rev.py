#!/usr/bin/env python3
"""One Grok P1 review of ATT-0105. Official drive would select Claude first."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0105-P1"
TARGET_ATTEMPT = "ATT-0105"
ENGINE = "grok"
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Grok P1 of ATT-0105; official drive would pick Claude; no model fallback",
