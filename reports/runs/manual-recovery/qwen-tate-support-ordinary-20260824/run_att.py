#!/usr/bin/env python3
"""One ordinary Qwen C66-TATE-SUPPORT mathematics turn.

Requires verified C66-SUPPORT-INTERFACE (ATT-0120) plus freshly merged WC.
Official retry on this cell is Qwen. Not C66-FULL, not forced, no model fallback.
"""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "ordinary Qwen TATE-SUPPORT after dual-confirmed "
