#!/usr/bin/env python3
"""One Codex P1 review of ATT-0113. PI override: Qwen quota exhausted until 12:50 UTC."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0113-P1"
TARGET_ATTEMPT = "ATT-0113"
ENGINE = "codex"
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["cursor-grok"], [ENGINE, "claude"]
            )
            ...
            launch = {
                "note": "Codex P1 of ATT-0113 cursor-grok TATE-SUPPORT; PI override after Qwen 429; no further model fallback",
            ...
            notify(
                "Pure Tate • Codex ATT-0113 P1 starting",
        ...
        notify("Pure Tate • Codex ATT-0113 P1 blocked", str(exc))
