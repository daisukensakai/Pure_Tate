    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["grok"], [ENGINE, "cursor-grok"]
            )
            ...
            launch = {
                "note": (
                    "Qwen P1 of ATT-0119 grok TATE-SUPPORT disproof; "
            ...
            notify(
                "Pure Tate • Qwen ATT-0119 P1 starting",
        ...
        notify("Pure Tate • Qwen ATT-0119 P1 blocked", str(exc))
