#!/usr/bin/env python3
"""Parallel xAI Grok FAUD of FND-0185, 0186, 0187 from REV-0171.

FND-0180 is already corroborated. No start notification. No model fallback.
"""
...
AUDIT_FINDING_IDS = ("FND-0185", "FND-0186", "FND-0187")
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "parallel xAI Grok FAUD of FND-0185..0187 from REV-0171; "
                    "FND-0180 already corroborated; no start notify; no model fallback"
                ),
                "jobs": jobs,
