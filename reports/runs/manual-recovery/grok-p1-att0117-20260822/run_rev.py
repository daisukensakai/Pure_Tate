#!/usr/bin/env python3
"""One xAI Grok P1 review of ATT-0117. Official first is cursor-grok; PI selects grok CLI."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0117-P1"
TARGET_ATTEMPT = "ATT-0117"
ENGINE = "grok"
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "xAI Grok P1 of ATT-0117 Codex TATE-SUPPORT; official first is cursor-grok; no model fallback",
            ...
            notify(
                "Pure Tate • Grok ATT-0117 P1 starting",
        ...
        notify("Pure Tate • Grok ATT-0117 P1 blocked", str(exc))
