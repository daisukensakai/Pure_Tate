#!/usr/bin/env python3
"""Serial Grok finding-audits of REV-0157 candidates FND-0162 and FND-0163."""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0162", "engine": "grok"},
    {"finding_id": "FND-0163", "engine": "grok"},
)
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "serial Grok audits of REV-0157 candidates FND-0162 and FND-0163; no model fallback",
                "jobs": [],
