#!/usr/bin/env python3
"""One ordinary Claude C66-GEO-COMP mathematics turn with current packet/WC."""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "ordinary Claude GEO-COMP; current packet+WC including FND-0158..0161; no forced-proof; no model fallback",
        ...
        notify("Pure Tate • Claude GEO-COMP blocked", str(exc))
