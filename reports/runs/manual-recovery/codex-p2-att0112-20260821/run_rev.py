#!/usr/bin/env python3
"""One Codex P2 review of ATT-0112. Official drive would pick Grok first."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0112-P2"
TARGET_ATTEMPT = "ATT-0112"
ENGINE = "codex"
TIMEOUT = 10800
...
def main() -> int:
    ...
    if int(task.get("review_pass") or 0) != 2:
        raise RuntimeError("expected review_pass=2, got %s" % task.get("review_pass"))
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Codex P2 of ATT-0112 Claude GEO-COMP lemma; P1 was Qwen REV-0157 confirmed; no model fallback",
            ...
            notify(
                "Pure Tate • Codex ATT-0112 P2 starting",
        ...
        notify("Pure Tate • Codex P2 blocked", str(exc))
