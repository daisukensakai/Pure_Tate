#!/usr/bin/env python3
"""One Qwen P1 review of ATT-0113. Official drive also picks Qwen first."""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "Qwen P1 of ATT-0113 cursor-grok TATE-SUPPORT; official first reviewer; no model fallback",
            ...
            notify(
                "Pure Tate • Qwen ATT-0113 P1 starting",
        ...
        notify("Pure Tate • Qwen ATT-0113 P1 blocked", str(exc))
