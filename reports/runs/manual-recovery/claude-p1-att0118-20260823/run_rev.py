#!/usr/bin/env python3
"""One Claude P1 review of ATT-0118. Official first is cursor-grok; PI selects Claude."""
...
CAMPAIGN_ID = "C66-001"
TASK_ID = "TASK-V-ATT-0118-P1"
TARGET_ATTEMPT = "ATT-0118"
ENGINE = "claude"
TIMEOUT = 10800
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            ledger, ledger_path = _new_run_ledger(
                CAMPAIGN_ID, 1, ["grok"], ["codex"], [ENGINE, "grok"]
            )
            ...
            launch = {
                "note": "Claude P1 of ATT-0118 Codex forced TATE-SUPPORT disproof; official first is cursor-grok; no model fallback",
            ...
            notify(
                "Pure Tate • Claude ATT-0118 P1 starting",
        ...
        notify("Pure Tate • Claude ATT-0118 P1 blocked", str(exc))
