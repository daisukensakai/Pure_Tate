#!/usr/bin/env python3
"""Parallel xAI Grok FAUD of FND-0188 and FND-0189 from REV-0174.

FND-0187 is already corroborated. No model fallback.
"""
...
AUDIT_FINDING_IDS = ("FND-0188", "FND-0189")
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": (
                    "parallel xAI Grok FAUD of FND-0188 and FND-0189; "
                    "FND-0187 already corroborated; no model fallback"
                ),
                "jobs": jobs,
