...
META = Path("/tmp/pure-tate-context-3step-meta.json")
...
def main():
    ...
    if job["kind"] == "finding-audit":
        ...
        msg = f"C66-001 • {aid} {job['finding_id']} verdict={payload.get('verdict')}"
    else:
    ...
    print("done", aid, job.get("result_verdict"), flush=True)
