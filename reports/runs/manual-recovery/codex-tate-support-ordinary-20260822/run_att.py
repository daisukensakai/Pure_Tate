...
Packet includes corroborated FND-0168 (ATT-0116 iff blocked). Cell ladder
exhausted; PI reuses Codex. Not C66-FULL, not forced.
"""
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "ordinary Codex TATE-SUPPORT; packet includes FND-0168; ladder exhausted reuse; no forced-proof; no model fallback",
