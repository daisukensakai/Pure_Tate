#!/usr/bin/env python3
"""Serial Codex finding-audits of FND-0186, then FND-0183, then FND-0184.

Claude is excluded from FND-0186. No model fallback.
"""
...
CAMPAIGN_ID = "C66-001"
JOBS = (
    {"finding_id": "FND-0186", "engine": "codex"},
    {"finding_id": "FND-0183", "engine": "codex"},
    {"finding_id": "FND-0184", "engine": "codex"},
)
TIMEOUT = 10800
...
def main() -> int:
    ...
    try:
        with CampaignRunLock(CAMPAIGN_ID):
            ...
            launch = {
                "note": "serial Codex FAUD of FND-0186 then 0183 then 0184; Claude excluded from 0186; no model fallback",
                "jobs": [],
